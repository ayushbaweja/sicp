...
; Solution: Applicative-order evaluates before expansion, and thus (test 0 (p)) will create a loop. Normal-order will expand the expression
; before reducing and thus 0 will be returned as x=0 is true.